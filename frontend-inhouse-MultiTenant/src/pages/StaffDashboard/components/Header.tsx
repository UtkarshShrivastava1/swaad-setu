...
export default function Header({
  ...
  const PLACE_ORDER_LINK =
    import.meta.env.VITE_USER_LINK || "http://localhost:5174/";
        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              ...
              {waiterCallCount > 0 && (
                <span className="absolute -top-1.5 -right-1.5 h-5 w-5 bg-red-500 text-white text-xs rounded-full flex items-center justify-center font-bold shadow-md">
                  {waiterCallCount}
                </span>
              )}
            </button>
