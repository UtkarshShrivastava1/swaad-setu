        ...
        <div className="text-center space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <button
              ...
              className="bg-black text-white hover:bg-[#111111] rounded-xl font-semibold text-lg px-8 py-4 shadow-hard group inline-flex items-center"
            >
              Connect with team
            ...
            <button
               onClick={() => scrollToSection('contact')}
              className="border-2 border-black text-black bg-white hover:bg-black hover:text-white rounded-xl font-semibold text-lg px-8 py-4 inline-flex items-center"
            >
              Book a Demo
            </button>
          </div>
